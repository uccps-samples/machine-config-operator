...
import (
	...
	cov1helpers "github.com/uccps-samples/library-go/pkg/config/clusteroperator/v1helpers"
	...
	v1 "github.com/uccps-samples/machine-config-operator/pkg/apis/machineconfiguration.uccp.io/v1"
...
func (optr *Operator) syncRelatedObjects() error {
	...
	coCopy := co.DeepCopy()
	// RelatedObjects are consumed by https://github.com/uccps-samples/must-gather
	co.Status.RelatedObjects = []configv1.ObjectReference{
		{Resource: "namespaces", Name: optr.namespace},
		{Group: "machineconfiguration.uccp.io", Resource: "machineconfigpools"},
		{Group: "machineconfiguration.uccp.io", Resource: "controllerconfigs"},
		{Group: "machineconfiguration.uccp.io", Resource: "kubeletconfigs"},
		{Group: "machineconfiguration.uccp.io", Resource: "containerruntimeconfigs"},
		{Group: "machineconfiguration.uccp.io", Resource: "machineconfigs"},
		...
		{Resource: "namespaces", Name: "uccp-kni-infra"},
		{Resource: "namespaces", Name: "uccp-openstack-infra"},
		{Resource: "namespaces", Name: "uccp-ovirt-infra"},
		{Resource: "namespaces", Name: "uccp-vsphere-infra"},
	}
...
func (optr *Operator) syncUpgradeableStatus() error {
	...
	// can resolve it.
	// [ref] https://github.com/uccps-samples/cluster-version-operator/blob/8402d219f36fc79e03edf45918785376113f2cc1/docs/dev/clusteroperator.md#what-should-an-operator-report-with-clusteroperator-custom-resource
	coStatus := configv1.ClusterOperatorStatusCondition{
...
func (optr *Operator) initializeClusterOperator() (*configv1.ClusterOperator, error) {
	...
	co.Status.RelatedObjects = []configv1.ObjectReference{
		{Resource: "namespaces", Name: optr.namespace},
		{Group: "machineconfiguration.uccp.io", Resource: "machineconfigpools", Name: "master"},
		{Group: "machineconfiguration.uccp.io", Resource: "machineconfigpools", Name: "worker"},
		{Group: "machineconfiguration.uccp.io", Resource: "controllerconfigs", Name: "machine-config-controller"},
	}
