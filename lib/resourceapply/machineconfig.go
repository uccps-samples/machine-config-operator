...
import (
	...
	"github.com/uccps-samples/machine-config-operator/lib/resourcemerge"
	mcfgv1 "github.com/uccps-samples/machine-config-operator/pkg/apis/machineconfiguration.uccp.io/v1"
	mcfgclientv1 "github.com/uccps-samples/machine-config-operator/pkg/generated/clientset/versioned/typed/machineconfiguration.uccp.io/v1"
