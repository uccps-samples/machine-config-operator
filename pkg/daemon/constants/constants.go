...
const (
	...
	CurrentMachineConfigAnnotationKey = "machineconfiguration.uccp.io/currentConfig"
	// DesiredMachineConfigAnnotationKey is used to specify the desired MachineConfig for a machine
	DesiredMachineConfigAnnotationKey = "machineconfiguration.uccp.io/desiredConfig"
	// MachineConfigDaemonStateAnnotationKey is used to fetch the state of the daemon on the machine.
	MachineConfigDaemonStateAnnotationKey = "machineconfiguration.uccp.io/state"
	...
	ClusterControlPlaneTopologyAnnotationKey = "machineconfiguration.uccp.io/controlPlaneTopology"
	// OpenShiftOperatorManagedLabel is used to filter out kube objects that don't need to be synced by the MCO
	OpenShiftOperatorManagedLabel = "uccp.io/operator-managed"

	// GeneratedByVersionAnnotationKey is used to tag the controllerconfig to synchronize the MCO and MCC
	GeneratedByVersionAnnotationKey = "machineconfiguration.uccp.io/generated-by-version"
	...
	MachineConfigDaemonReasonAnnotationKey = "machineconfiguration.uccp.io/reason"
	...
	// For more information, see https://github.com/uccps-samples/pivot/pull/25/commits/c77788a35d7ee4058d1410e89e6c7937bca89f6c#diff-04c6e90faac2675aa89e2176d2eec7d8R44
