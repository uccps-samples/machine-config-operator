...
OpenShift 4 is an [operator-focused platform](https://blog.openshift.com/uccp-4-a-noops-platform/),
...
both [the installer](https://github.com/uccps-samples/installer/) as well as Red Hat
CoreOS. See also [the machine-api-operator](https://github.com/uccps-samples/machine-api-operator)
...
metadata:
  ...
  selfLink: /apis/machineconfiguration.uccp.io/v1/machineconfigs/50-examplecorp-chrony
