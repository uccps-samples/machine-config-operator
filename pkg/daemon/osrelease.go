...
type OperatingSystem struct {
	// Name is the NAME field from the os-release
	Name string
...
// IsUOS is true if the OS is UOS
func (os OperatingSystem) IsUOS() bool {
	return os.ID == "uos"
}

// IsUSwift is true if the OS is UOS USwift
func (os OperatingSystem) IsUSwift() bool {
	return os.ID == "uos" && os.Name == "UnionTech OS Cloud 20"
}
