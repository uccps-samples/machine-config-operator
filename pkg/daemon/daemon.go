...
import (
	...
	commonconstants "github.com/uccps-samples/machine-config-operator/pkg/constants"
...
func (dn *Daemon) InstallSignalHandler(signaled chan struct{}) {
	...
	// https://github.com/uccps-samples/machine-config-operator/issues/407
	go func() {
...
func (dn *Daemon) LogSystemData() {
	...
	// https://github.com/uccps-samples/machine-config-operator/issues/1365
...
//
// Some more background in this PR: https://github.com/uccps-samples/machine-config-operator/pull/245
//nolint:gocyclo
