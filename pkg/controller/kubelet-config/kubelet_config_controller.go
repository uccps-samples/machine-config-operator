...
import (
	...
	oseinformersv1 "github.com/uccps-samples/client-go/config/informers/externalversions/config/v1"
	oselistersv1 "github.com/uccps-samples/client-go/config/listers/config/v1"
...
const (
	...
	defaultOpenshiftTLSSecurityProfileConfig = "apiserver.v1.config.uccp.io"
)
