...
import (
	...
	cligoinformersv1 "github.com/uccps-samples/client-go/config/informers/externalversions/config/v1"
	cligolistersv1 "github.com/uccps-samples/client-go/config/listers/config/v1"
	operatorinformersv1alpha1 "github.com/uccps-samples/client-go/operator/informers/externalversions/operator/v1alpha1"
	operatorlistersv1alpha1 "github.com/uccps-samples/client-go/operator/listers/operator/v1alpha1"
	...
	mtmpl "github.com/uccps-samples/machine-config-operator/pkg/controller/template"
	mcfgclientset "github.com/uccps-samples/machine-config-operator/pkg/generated/clientset/versioned"
	"github.com/uccps-samples/machine-config-operator/pkg/generated/clientset/versioned/scheme"
	mcfginformersv1 "github.com/uccps-samples/machine-config-operator/pkg/generated/informers/externalversions/machineconfiguration.uccp.io/v1"
	mcfglistersv1 "github.com/uccps-samples/machine-config-operator/pkg/generated/listers/machineconfiguration.uccp.io/v1"
...
const (
	...
	builtInLabelKey = "machineconfiguration.uccp.io/mco-built-in"
)
