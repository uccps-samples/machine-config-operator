...
const (
	...
	// https://github.com/uccps-samples/machine-config-operator/issues/301
...
// see https://github.com/uccps-samples/machine-config-operator/issues/301
...
func (ctrl *Controller) garbageCollectRenderedConfigs(pool *mcfgv1.MachineConfigPool) error {
	// Temporarily until https://github.com/uccps-samples/machine-config-operator/pull/318
	// which depends on the strategy for https://github.com/uccps-samples/machine-config-operator/issues/301
	return nil
}
