...
import (
	...
	e2eShared "github.com/uccps-samples/machine-config-operator/test/e2e-shared-tests"
...
// Test case for https://github.com/uccps-samples/machine-config-operator/issues/358
func TestMCDToken(t *testing.T) {
	...
	mcdList, err := cs.Pods("uccp-machine-config-operator").List(context.TODO(), listOptions)
	require.Nil(t, err)
